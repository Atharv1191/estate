    ...
    <div className='pt-10 px-4 md:px-20 lg:px-32 bg-gray-900 overflow-hidden w-full' id='Footer'>
        <div className='container mx-auto flex flex-col md:flex-row justify-between items-center'>
            ...
            <div className='flex gap-2'>
                <input className='p-2 rounded bg-gray-800 text-gray-400 border border-gray-700 focous:outline-none w-full md:w-auto' type='email' placeholder='Enter your email'/>
        ...
        <div className='border-t border-gray-700 py-4 mt-10 text-center text-gray-50'>
            Copyright 2024 @Atharv. All Right Reserved.
        </div>
    </div>
  )
}
